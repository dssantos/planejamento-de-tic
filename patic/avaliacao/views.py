...
def avaliacao(request):
    if request.method == 'POST' and 'btn_upload' in request.POST:
        ...
        if form.is_valid():
            ...
            context['avaliador3'] = form.cleaned_data['avaliador3']
            context['orgao_avaliador3'] = form.cleaned_data['orgao_avaliador3']
            context['avaliador4'] = form.cleaned_data['avaliador4']
            context['orgao_avaliador4'] = form.cleaned_data['orgao_avaliador4']
